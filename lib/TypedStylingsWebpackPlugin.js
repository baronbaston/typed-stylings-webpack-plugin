...
var TypedStylingsWebpackPlugin = /** @class */ (function () {
    ...
    TypedStylingsWebpackPlugin.prototype.cleanupFiles = function () {
        var _this = this;
        var start = Date.now();
        this.includePaths
            .map(function (dir) { return _this.walkSync(dir); })
            .forEach(function (files) { return files
            .filter(function (file) { return _this.preProcessors.some(function (preProcessor) { return preProcessor.test(file.path); }); })
